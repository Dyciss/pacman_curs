...
void move_pacman() {
    ...
    map_xy_to_window_xy(game->alpha, game->pacman->x, game->pacman->y, &game->pacman->window_x, &game->pacman->window_y);
    printf("PACMAN -- (%i, %i) -- (%f, %f)\n", game->pacman->x, game->pacman->y, game->pacman->window_x, game->pacman->window_y);
